...
type ReturnTyp1<T extends (...args: any) => any> = T extends (
  ...args: any
) => infer R
  ? R
  : any;
...
const content = `Hello, I am a ${occupation}`;

type Occupation = "Web Developer";
type Content = `Hello, I am a ${Occupation}`;

type HandledEvent = "change" | "click" | "keydown";
type EventHandler = `on${HandledEvent}`;
...
type NumberArray1 = valueOrArray<number>;
let numberArray1: NumberArray1 = 0;
numberArray1 = [2, 0];
...
type Conference = keyof conference;
